...
def addDeepRenderOption():
    ...
    outputPath = "%s/%s/%s/%s/%s/vrst/%s_%s..vrst" % (cmds.workspace(lfw=True)[0],cmds.workspace(fre="images"),curMayaFile,curRenderLayer,resRender,curMayaFile,curRenderLayer)
